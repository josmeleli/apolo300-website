          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-3">
              <div className="flex items-start justify-center md:justify-start">
                ...
                <span className="text-blue-200 text-sm">Av. Julio C. Tello 1438 Urb. Risso - Lince, Lima</span>
              </div>
              ...
              <div className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-blue-200 text-sm">+51 965 403 101 - Área Comercial</span>
              </div>
              ...
              <div className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-blue-200 text-sm">+51 944 574 187 - Selección de Personal</span>
              </div>
              ...
              <div className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-blue-200 text-sm">comercial@apolo300.com</span>
              </div>
              ...
              <div className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-blue-200 text-sm">seleccion@apolo300.com</span>
              </div>
            </div>
          </div>
        </div>
