          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center">
              <div className="bg-blue-900 p-3 rounded">
                <div className="text-white font-bold text-xl">TENSE</div>
              </div>
              <div className="ml-4 text-blue-900">
                <div className="text-base font-medium">¡Nuestro compromiso,</div>
                <div className="text-base font-medium">tu seguridad!</div>
              </div>
            </div>
